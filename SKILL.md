...
description: "Maestro mobile E2E testing patterns for React Native/Expo apps: YAML test flows, testID selectors, adaptive auth state, optimistic update verification, GraalJS scripting, cross-platform stability, CI/CD integration, Maestro Cloud, and MCP server integration. Use when writing mobile E2E tests, debugging flaky flows, testing authentication, verifying optimistic updates, or setting up Maestro CI."
license: MIT
metadata:
  version: 1.1.0
  category: toolchain
